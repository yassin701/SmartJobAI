...
export default function Home() {
  return (
    <>
      <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 dark:from-slate-900 dark:to-slate-800 transition-colors duration-500">

        {/* Hero Section */}
        <section className="relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-900 opacity-50 dark:opacity-30"></div>
          <div className="absolute top-10 right-10 w-64 h-64 bg-blue-200 dark:bg-blue-900/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-70"></div>
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-purple-200 dark:bg-purple-900/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-70"></div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                Why choose <span className="text-blue-600 dark:text-blue-400">SmartJob </span>?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* Feature 1 */}
              <div className="group relative bg-gradient-to-br from-white to-blue-50 dark:from-slate-800 dark:to-slate-800/80 border border-blue-100 dark:border-slate-700 rounded-2xl p-8 hover:shadow-2xl hover:shadow-blue-900/20 hover:border-blue-200 dark:hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Precise Matching</h3>
              ...
              {/* Feature 2 */}
              <div className="group relative bg-gradient-to-br from-white to-purple-50 dark:from-slate-800 dark:to-slate-800/80 border border-purple-100 dark:border-slate-700 rounded-2xl p-8 hover:shadow-2xl hover:shadow-purple-900/20 hover:border-purple-200 dark:hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Optimized Applications</h3>
                  <p className="text-gray-600 dark:text-gray-400">
              ...
              {/* Feature 3 */}
              <div className="group relative bg-gradient-to-br from-white to-green-50 dark:from-slate-800 dark:to-slate-800/80 border border-green-100 dark:border-slate-700 rounded-2xl p-8 hover:shadow-2xl hover:shadow-green-900/20 hover:border-green-200 dark:hover:border-green-500/50 transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Time Saving</h3>
                  <p className="text-gray-600 dark:text-gray-400">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-900 dark:to-purple-900 transition-colors duration-500">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
